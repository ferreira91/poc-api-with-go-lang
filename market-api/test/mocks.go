...
func (m *MockIMarketService) Create(market domain.IMarket) (domain.IMarket, error) {
	m.ctrl.T.Helper()
...
// MockICreateMarketService is a mock of ICreateMarketService interface.
type MockICreateMarketService struct {
	ctrl     *gomock.Controller
	recorder *MockICreateMarketServiceMockRecorder
}

// MockICreateMarketServiceMockRecorder is the mock recorder for MockICreateMarketService.
type MockICreateMarketServiceMockRecorder struct {
	mock *MockICreateMarketService
}

// NewMockICreateMarketService creates a new mock instance.
func NewMockICreateMarketService(ctrl *gomock.Controller) *MockICreateMarketService {
	mock := &MockICreateMarketService{ctrl: ctrl}
	mock.recorder = &MockICreateMarketServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockICreateMarketService) EXPECT() *MockICreateMarketServiceMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockICreateMarketService) Create(market domain.IMarket) (domain.IMarket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", market)
	ret0, _ := ret[0].(domain.IMarket)
	ret1, _ := ret[1].(error)
...
// Create indicates an expected call of Create.
func (mr *MockICreateMarketServiceMockRecorder) Create(market interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockICreateMarketService)(nil).Create), market)
}

// MockIFindMarketService is a mock of IFindMarketService interface.
type MockIFindMarketService struct {
	ctrl     *gomock.Controller
	recorder *MockIFindMarketServiceMockRecorder
}

// MockIFindMarketServiceMockRecorder is the mock recorder for MockIFindMarketService.
type MockIFindMarketServiceMockRecorder struct {
	mock *MockIFindMarketService
}

// NewMockIFindMarketService creates a new mock instance.
func NewMockIFindMarketService(ctrl *gomock.Controller) *MockIFindMarketService {
	mock := &MockIFindMarketService{ctrl: ctrl}
	mock.recorder = &MockIFindMarketServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIFindMarketService) EXPECT() *MockIFindMarketServiceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockIFindMarketService) Get(township, region5, name, district string) ([]domain.IMarket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", township, region5, name, district)
	ret0, _ := ret[0].([]domain.IMarket)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockIFindMarketServiceMockRecorder) Get(township, region5, name, district interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockIFindMarketService)(nil).Get), township, region5, name, district)
}

// GetAll mocks base method.
func (m *MockIFindMarketService) GetAll() ([]domain.IMarket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll")
	ret0, _ := ret[0].([]domain.IMarket)
	ret1, _ := ret[1].(error)
...
// GetAll indicates an expected call of GetAll.
func (mr *MockIFindMarketServiceMockRecorder) GetAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockIFindMarketService)(nil).GetAll))
}

// GetByID mocks base method.
func (m *MockIFindMarketService) GetByID(id int64) (domain.IMarket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByID", id)
	ret0, _ := ret[0].(domain.IMarket)
	ret1, _ := ret[1].(error)
...
// GetByID indicates an expected call of GetByID.
func (mr *MockIFindMarketServiceMockRecorder) GetByID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByID", reflect.TypeOf((*MockIFindMarketService)(nil).GetByID), id)
}

// MockIUpdateMarketService is a mock of IUpdateMarketService interface.
type MockIUpdateMarketService struct {
	ctrl     *gomock.Controller
	recorder *MockIUpdateMarketServiceMockRecorder
}

// MockIUpdateMarketServiceMockRecorder is the mock recorder for MockIUpdateMarketService.
type MockIUpdateMarketServiceMockRecorder struct {
	mock *MockIUpdateMarketService
}

// NewMockIUpdateMarketService creates a new mock instance.
func NewMockIUpdateMarketService(ctrl *gomock.Controller) *MockIUpdateMarketService {
	mock := &MockIUpdateMarketService{ctrl: ctrl}
	mock.recorder = &MockIUpdateMarketServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIUpdateMarketService) EXPECT() *MockIUpdateMarketServiceMockRecorder {
	return m.recorder
}

// Update mocks base method.
func (m *MockIUpdateMarketService) Update(id int64, market domain.IMarket) (domain.IMarket, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", id, market)
	ret0, _ := ret[0].(domain.IMarket)
	ret1, _ := ret[1].(error)
...
// Update indicates an expected call of Update.
func (mr *MockIUpdateMarketServiceMockRecorder) Update(id, market interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIUpdateMarketService)(nil).Update), id, market)
}

// MockIDeleteMarketService is a mock of IDeleteMarketService interface.
type MockIDeleteMarketService struct {
	ctrl     *gomock.Controller
	recorder *MockIDeleteMarketServiceMockRecorder
}

// MockIDeleteMarketServiceMockRecorder is the mock recorder for MockIDeleteMarketService.
type MockIDeleteMarketServiceMockRecorder struct {
	mock *MockIDeleteMarketService
}

// NewMockIDeleteMarketService creates a new mock instance.
func NewMockIDeleteMarketService(ctrl *gomock.Controller) *MockIDeleteMarketService {
	mock := &MockIDeleteMarketService{ctrl: ctrl}
	mock.recorder = &MockIDeleteMarketServiceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIDeleteMarketService) EXPECT() *MockIDeleteMarketServiceMockRecorder {
	return m.recorder
}

// DeleteByRegistry mocks base method.
func (m *MockIDeleteMarketService) DeleteByRegistry(registry string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteByRegistry", registry)
	ret0, _ := ret[0].(error)
	return ret0
...
// DeleteByRegistry indicates an expected call of DeleteByRegistry.
func (mr *MockIDeleteMarketServiceMockRecorder) DeleteByRegistry(registry interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteByRegistry", reflect.TypeOf((*MockIDeleteMarketService)(nil).DeleteByRegistry), registry)
}
